...
## 목적 (Purpose)
개발팀이 본 문서만으로 OMS(Order Management System), WMS(Warehouse Management System), Master Data Hub의 구현이 가능한 수준의 기능/인터페이스/데이터/운영 요구사항을 제공한다.
...
## 5. 인터페이스/데이터/프로세스 연결
- REST API 상세: `arch_oms_wms_api_spec_v2.yaml` 참조
- 데이터 모델/ERD: `db_schema_oms_wms_v1.md` 참조
- 주문-배송 상세 절차 및 예외 흐름: `arch_oms_wms_process_flow_v1.md` 참조
...
## 변경 이력 (Change Log)
- v2.0 (2026-04-10): 정책 준수 문서로 재정리
- v1.0 (2026-04-10): 초안 작성
